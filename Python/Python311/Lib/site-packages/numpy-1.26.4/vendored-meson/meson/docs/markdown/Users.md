...
topic](https://github.com/topics/meson).
 ...
 - [Akira](https://github.com/akiraux/Akira), a native Linux index for UI and UX design built in Vala and Gtk
 ...
 - [GNOME Software](https://gitlab.gnome.org/GNOME/gnome-software), an index store for GNOME
 - [GNOME Twitch](https://github.com/vinszent/gnome-twitch), an index for viewing Twitch streams on GNOME desktop
 ...
 - [Libhttpseverywhere](https://git.gnome.org/browse/libhttpseverywhere), a library to enable httpseverywhere on any desktop index
