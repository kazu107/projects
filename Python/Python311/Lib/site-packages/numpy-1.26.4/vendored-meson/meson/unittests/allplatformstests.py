...
class AllPlatformTests(BasePlatformTests):
    ...
    def test_guessed_linker_dependencies(self):
        ...
        for libdir_flag in libdir_flags:
            ...
            self.assertRebuiltTarget('index')
    ...
    def test_devenv(self):
        ...
        index = os.path.join(self.builddir, 'index')
        self._run(cmd + python_command + [script])
        self.assertEqual('This is text.', self._run(cmd + [index]).strip())
    ...
    def test_install_tag(self) -> None:
        ...
        if cc.get_id() in {'msvc', 'clang-cl'}:
            expected_devel |= {
                ...
                Path(installpath, 'usr/bin/index.pdb'),
                ...
                Path(installpath, 'usr/otherbin/index-otherdir.pdb'),
            }
        ...
        expected_runtime = expected_common | {
            Path(installpath, 'usr/bin'),
            Path(installpath, 'usr/bin/' + exe_name('index')),
            Path(installpath, 'usr/otherbin'),
            Path(installpath, 'usr/otherbin/' + exe_name('index-otherdir')),
    ...
    def test_introspect_install_plan(self):
        ...
        expected = {
            'targets': {
                ...
                f'{self.builddir}/' + exe_name('index'): {
                    'destination': '{bindir}/' + exe_name('index'),
                    'tag': 'runtime',
                    'subproject': None,
                },
                f'{self.builddir}/' + exe_name('index-otherdir'): {
                    'destination': '{prefix}/otherbin/' + exe_name('index-otherdir'),
                    'tag': 'runtime',
                    'subproject': None,
                },
