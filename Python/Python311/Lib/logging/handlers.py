...
class RotatingFileHandler(BaseRotatingHandler):
    ...
    def __init__(self, filename, mode='a', maxBytes=0, backupCount=0,
        ...
        and a base file name of "index.log", you would get "index.log",
        "index.log.1", "index.log.2", ... through to "index.log.5". The file being
        written to is always "index.log" - when it gets filled up, it is closed
        and renamed to "index.log.1", and if files "index.log.1", "index.log.2" etc.
        exist, then they are renamed to "index.log.2", "index.log.3" etc.
        respectively.
